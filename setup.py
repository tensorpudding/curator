...
_data_files = [
    ...
    ('share/icons/ubuntu-mono-dark/apps/16', ['share/icons/ubuntu-mono-dark/apps/16/curator.svg']),
    ('share/icons/ubuntu-mono-dark/apps/22', ['share/icons/ubuntu-mono-dark/apps/22/curator.svg']),
    ('share/icons/ubuntu-mono-dark/apps/24', ['share/icons/ubuntu-mono-dark/apps/24/curator.svg']),
    ('share/icons/ubuntu-mono-dark/apps/48', ['share/icons/ubuntu-mono-dark/apps/48/curator.svg']),
    ('share/icons/ubuntu-mono-light/apps/16', ['share/icons/ubuntu-mono-light/apps/16/curator.svg']),
    ('share/icons/ubuntu-mono-light/apps/22', ['share/icons/ubuntu-mono-light/apps/22/curator.svg']),
    ('share/icons/ubuntu-mono-light/apps/24', ['share/icons/ubuntu-mono-light/apps/24/curator.svg']),
    ('share/icons/ubuntu-mono-light/apps/48', ['share/icons/ubuntu-mono-light/apps/48/curator.svg']),

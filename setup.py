...
_data_files = [
    ...
    ('share/icons/ubuntu-mono-dark/apps/16', ['share/icons/ubuntu-mono-dark/apps/16/curator-tray.svg']),
    ('share/icons/ubuntu-mono-dark/apps/22', ['share/icons/ubuntu-mono-dark/apps/22/curator-tray.svg']),
    ('share/icons/ubuntu-mono-dark/apps/24', ['share/icons/ubuntu-mono-dark/apps/24/curator-tray.svg']),
    ('share/icons/ubuntu-mono-dark/apps/48', ['share/icons/ubuntu-mono-dark/apps/48/curator-tray.svg']),
    ('share/icons/ubuntu-mono-light/apps/16', ['share/icons/ubuntu-mono-light/apps/16/curator-tray.svg']),
    ('share/icons/ubuntu-mono-light/apps/22', ['share/icons/ubuntu-mono-light/apps/22/curator-tray.svg']),
    ...
    ('share/pixmaps', ['share/pixmaps/curator.png', 'share/pixmaps/curator.xpm']),
